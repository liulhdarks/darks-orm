...
public class SpringConnectionFactory extends ConnectionHandler
{
    ...
    {
        logger.debug("Get Spring Connection");
    ...
    public Connection getConnection()
    {
        ...
        {
            throw new DataSourceException("Spring datasource getConnection failed", e);
        }
    }
}